...
def post_detail(request, year, month, day, post_slug):
    query_params = dict()
    query_params["slug"] = post_slug
    query_params["status"] = 'published'
    query_params["publish__year"] = year
    query_params["publish__month"] = month
    query_params["publish__day"] = day
    post = get_object_or_404(Post, **query_params)
